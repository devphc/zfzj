...
Page({
  ...
  orderDetail : function (e) {
    ...
    wx.navigateTo({
      url: "/pages/order-detailss/index?id=" + orderId
    })
  },
     ...
     wx.showModal({
      ...
      success: function(res) {
        if (res.confirm) {
          wx.showLoading();
          wx.request({
            url: app.globalData.domains + '/api/order/cancelOrder',
            data: {
  ...
  toPayTap:function(e){
    ...
    wxpay.wxpay(app, money, orderId, "/pages/order-lists/index");
  },
  ...
  onShow:function(){
    ...
    wx.request({
      url: app.globalData.domains + '/api/order/getOrderList',
      data: postData,
      success: (res) => {
        wx.hideLoading();
        if (res.data.code == 0) {
